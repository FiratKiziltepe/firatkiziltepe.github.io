...
- **Sayı kartları:** Include / Exclude / Maybe kartlarında büyük sayı o anki kararı gösterir (bulutta nihai karar, yerelde oyunuz; yoksa AI kararı). Altında kaçının nihai karardan/oyunuzdan, AI'nın toplam kaçına bu kararı verdiği yazar. "Tüm aktif kayıtlar / Geçerli filtre" ile sayıların kapsamı değiştirilir. Bulutta "⚖️ Nihai verilen x/N" ilerlemesi de görünür.
- **Hariç tutma gerekçesi (Rayyan gibi):** Karar panelindeki "✕ Gerekçeyle hariç…" (kısayol **R**) protokolün EC ölçütlerini, sık kullanılan gerekçeleri ve projeye eklenenleri listeler; kendi gerekçenizi yazıp Enter ile eklersiniz. Gerekçe seçmek oyu "Hariç" yapar; gerekçesiz hariç için ✕ yeterlidir. Seçim çubuğundaki "✕ + gerekçe…" ile topluca uygulanır. Etiket/gerekçe menüsünden gerekçeye göre süzülür; dışa aktarımda gerekçe sütunları vardır. Oy Dahil/Belirsiz'e dönerse gerekçeler kalkar.
- **Etiketler:** "+ Etiket" projedeki tüm etiketleri aranabilir listeyle sunar; yeni etiket anında herkese önerilir (kör modda da).
- **Arşiv:** Seçili kayıtlar "🗄️ Arşive kaldır" ile çalışma listesinden ve tüm sayılardan çıkarılır; silinmez. Durum → "🗄️ Arşivdekiler" ile görülür, satırdaki "↩ Arşivden çıkar" ya da toplu düğmeyle geri alınır. Tekrar kaldırmadan ayrıdır (PRISMA tekrar sayısını etkilemez); dışa aktarımda "Durum: Arşivde" yazar.
- **En yakın çalışmalar:** başlık (DOI bağlantılı), yazar · yıl · tür, DOI/WoS, geçerli karar, ilişki gerekçesi ve açılır özetle kart olarak listelenir.
- **Belge türü ve yıl:** "📄 Belge türü" listesinden bir ya da birden çok tür (ör. Proceedings Paper, Review) ve 📅 yıl aralığı seçilebilir; "Filtredekilerin tümünü seç" ile bunlara topluca oy ya da nihai karar işlenir. "✕ Filtreleri temizle" tüm filtreleri ve sıralamayı varsayılana döndürür. Tablo başlığındaki Başlık / Yazar / Yıl / Güven düğmeleriyle sıralanır (tekrar tıklayınca yön değişir).
